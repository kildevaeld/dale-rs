    ...
    <S::Output as IntoOutcome<R>>::Failure: Into<E>,
{
    ...
    type Future = ErrIntoFuture<S::Future, R, E>;
...
pin_project! {
    ...
    pub struct ErrIntoFuture<T, R, E> {
        #[pin]
        future: T,
        _r: PhantomData<R>,
        _e: PhantomData<E>
...
unsafe impl<T, R, E> Send for ErrIntoFuture<T, R, E> where T: Send {}

impl<T, R, E> Future for ErrIntoFuture<T, R, E>
where
    T: Future,
